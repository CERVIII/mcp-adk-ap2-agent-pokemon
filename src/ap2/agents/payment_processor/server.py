...
from ap2.protocol import (
    ...
    # validate_user_authorization,  # TODO: Implement JWT validation
    # JWTValidationError,  # TODO: Implement JWT validation
    AP2_EXTENSION_URI
)
...
async def charge_payment(request: Dict[str, Any], db: Session = Depends(get_db)):
    ...
    try:
        ...
        # TODO: Validate user authorization JWT signature (not yet implemented)
        print("\n🔍 User authorization validation skipped (development mode)")
        # try:
